...
{/* <div className={`form-check form-switch text-${props.newmode==='green'?'light':'green'}`}>   
     <input className="form-check-input" type="checkbox" onClick={props.greenMode} role="switch" id="flexSwitchCheckDefault"/>
  <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable {props.newmode==='green'?'light':'green'} Mode</label>
</div> */}
